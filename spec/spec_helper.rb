...
RUN_COVERAGE = minimum_version.call("2.6") && (ENV.fetch("COVER_ALL") { ENV.fetch("CI_CODECOV") { ENV["CI"].nil? } })
ALL_FORMATTERS = actual_version.call(2, 7) && (ENV.fetch("COVER_ALL") { ENV.fetch("CI_CODECOV") { ENV.fetch("CI", nil) } })
